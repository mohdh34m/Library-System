...
function HeroSection() {
  return (
    <div className="h-[700px] flex flex-col sm:justify-center sm:items-center md:flex-row">
        <div>
            ...
            <div>
                <button className='h-[60px] w-[150px] bg-highlightBrown border-b-4  text-textAliceBlue text-[22px] font-bold rounded-2xl m-5'>Get started</button>
            </div>
        </div>
        <div>
